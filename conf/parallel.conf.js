...
exports.config = {
    ...
    afterEach: async function () {
        ...
        try {
            // Update LambdaTest metadata
            await browser.execute('lambda-status=' + this.currentTest.state);
            await browser.execute('lambda-name=' + this.currentTest.title);
  ...
  specs: [
    ...
    '../tests/specs/single_test1.js',
    '../tests/specs/single_test2.js'
  ],
  exclude: [],
